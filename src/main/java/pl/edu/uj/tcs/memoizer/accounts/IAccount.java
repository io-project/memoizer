...
public interface IAccount {
	...
	/**
	 * If needed, here we autenticate/authorise accounts to which we want to log in. For example, like in cloud it is needed to make authorisation by get token from webside which is given after request in logIn function.
	 ...
	 * @param pathOnCloud Path to which we want to save file on cloud service.
	 * @throws ConnectionException When occurs problem with network connection.
	...
	/**
	 * Saves vytes to Cloud service.
	 * @param bytesToSave Bytes which we want to save on cloud service.
	 * @param pathOnCloud Path to which we want to save bytes on cloud service.
	 * @throws ConnectionException When occurs problem with network connection.
	 * @throws IOException Throws this exception when occurs any problem with file streams or any other IO problem/
	 * @throws NotLoggedException This exception is thrown when User is not logged to service.
	 */
	...
	/**
	 * Download bytes saved in file on path like in argument in cloud service.
	 * @param pathOnCloud Path to file on Cloud service wanted to be saved on localhost.
	 * @return Butes saved in file in cloud
	 * @throws ConnectionException When occurs problem with network connection.
	 * @throws IOException Throws this exception when occurs any problem with file streams or any other IO problem/
	 * @throws NotLoggedException This exception is thrown when User is not logged to service.
	 * @throws NoFileException This exception is thrown when path to file on Cloud service accound is not proper.
